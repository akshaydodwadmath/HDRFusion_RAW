function out = raw_process(fname, rapp, btype, index)
...
filename = fname;
read_app = rapp;               % 'DNG' for .dng  or  'DCRAW' for .tiff
bayer_type = btype;
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
%imwrite(lin_rgb, append('CR2/Scene2New/lin_rgb',int2str(index),'.png'),'png');
out = lin_rgb;
